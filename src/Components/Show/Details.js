...
export const DetailedInformation = [
    ...
    {
        title: 'Trash To Cash',
        status: 'Deployment of Application',
    ...
    },
    {
        ...
        linksTrue: true,
        links: [
            {   "title": "Click here to go to App Store",
