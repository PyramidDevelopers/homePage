            ...
            <div className="about__bottom">
                <div className="about__left">
                    <div className="text">
                        ...
                        <div className="para1">
                            <p>Simply put, college students looking to make it big.We develop apps, make website, design interfaces, create backend architecture and much more.</p>
                        </div>
                        <div className="para2">
                            <p>We may still be in college but we bring a vast skillset to the table.We have made comprehensive and quality digital products from numerous clients.</p>
                        </div>
                    </div>
                        ...
                        <div className="images__inner">
                            <div className="images__innerLeft">
                                <div className="images__innerInnerLeft">
                                    <img className="images__innerInnerLeftInside" src={RightImage} alt=""/>
                                </div>
